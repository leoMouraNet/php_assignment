      ...
      <br>
        ...
        foreach ($categoryList as $category) :?>
          <tr class="item_row">
                ...
                <td>
                <a href="?route=category/list&method=delete&parameter=<?php echo $category['category_id']; ?>" onclick="return confirm('Are you sure you want to delete this item?');">Del</a>
